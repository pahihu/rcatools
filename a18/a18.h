...
#define NOFILLER	"Missing Filler Byte"
...
#define NOEXP     	"-x Option Ignored -- No File Name"
...
#define CONST		20		/*    AP: define constant       */
#define EXPSYM		21		/*    AP: export symbols        */
...
#define EXPO		0x2000  /*              is exported             */
